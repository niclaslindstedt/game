...
// tree (`website/scripts/levels/*.yaml`) into the engine's LevelDef catalog —
...
const banner = `// @generated by website/scripts/generate-levels.mjs — DO NOT EDIT.
// Source of truth: website/scripts/levels/*.yaml. Regenerate with
