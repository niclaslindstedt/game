...
const SPRITES = {
  ...
  // The item card's gear-slot glyphs (ItemCard.tsx), siblings of the
  // icon_class_* weapon glyphs: 1× beside the item name, replacing the
  // "HEAD ARMOR"-style headline. Armor slots in light steel, the charm a
  // lucky gold clover, the bag a scavenger-brown satchel.
  icon_slot_head: [
    "............",
    "...OOOOOO...",
    "..OVVVVVVO..",
  ...
  // A generic lucky trinket (moon / red-dust / stardust charms all wear it): a
  // blue gem set in a gold pendant, its cyan facet catching the light.
  icon_charm: [
    "....OO......",
    "...OhqO.....",
    "..OhhhhO....",
  ...
  // The RAILGUN: a heavy twin-rail barrel — steel rail, glowing slug channel,
  // steel rail — bolted onto a dark capacitor bank.
  icon_railgun: [
    "............",
    "............",
    "...OOOOOOOOO",
  ...
  // ADA'S TRAIL: the five traces she leaves across the campaign (story items,
  // see src/game/defs/story.ts). Small found objects, outlined like the rest.
  // Her crushed soda can (red body, white label band, a dent in the side).
  icon_ada_soda: [
    "............",
    "...OOOO.....",
    "..OVVVVO....",
  ...
  // Her lost sneaker, toe to the right — white with blue stripes, rubber sole.
  icon_ada_sneaker: [
    "............",
    "............",
    "......OOOO..",
  ...
  // "I AM NOT CARGO" — a steel pod panel gouged with angry scratches.
  icon_ada_message: [
    "............",
    ".OOOOOOOOO..",
    ".OvvvvvvvO..",
  ...
  // A scrap of her zipper-fixed jacket — ragged blue fabric, a lighter seam.
  icon_ada_jacket: [
    "............",
    "...OOO......",
    "..OjjOO.....",
  ...
  // The jammed host's cowboy hat — narrow crown, band, wide curled brim.
  icon_ada_host: [
    "............",
    "............",
    "....OOOO....",
