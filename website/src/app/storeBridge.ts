...
// (app/), where StoreKit / Play Billing live; this module speaks to it over
...
//
// The protocol (mirrored by app/src/storePurchases.ts — keep the two in step):
...
declare global {
  interface Window {
    /** The WebView's message channel into the native shell (app/App.tsx). */
