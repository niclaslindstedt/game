...
const HELP_LINES = [
  ...
  "TOUCH HOLD A FINGER DOWN.",
  "",
  "TAP OR PRESS SPACE TO JUMP - MOON",
  "GRAVITY CARRIES YOU OVER THE GHOSTS.",
  "",
  ...
  "",
  "CLICK (OR TWO-FINGER TAP, OR E) TO",
        ...
        },
        {
          ...
          blurb:
            s.itemUse === "auto"
              ...
              : "CLICK / TWO-FINGER TAP / E SPENDS ONE",
          action: () => {
            playUiSound(synth, "confirm");
            updateSettings({
