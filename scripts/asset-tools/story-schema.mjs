...
/**
 * The longest line the dialogue box and the cutscene caption fit without
 * wrapping — measured from the shipped campaign, whose widest line is exactly
 * this long. A longer line still renders; it just stops being the author's
 * line break, which is the whole craft of writing for a fixed box.
 */
