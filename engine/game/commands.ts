...
export const RUN_COMMAND_ARGS = {
  ...
  // THE CACHE — the garage chest (engine/game/cache.ts). Both verbs name a CELL,
  ...
  // THE TABLE — trade (engine/game/trade.ts). Every one of these acts for the
  ...
  // THE DRIVEWAY — climbing into the hub's car (engine/game/vehicles.ts). No
  ...
  // THE ROAD — an in-session crossing (engine/game/travel.ts). The
  ...
  // TEAR A SEAM HOME — the rift tool's own verb (engine/game/rift-tool.ts). No
  ...
  // THE TOWN PORTAL — a SOLO crossing (engine/game/travel.ts). The same two
