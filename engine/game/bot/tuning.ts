...
// hand-authored source of truth, compiled to `engine/generated/botTuning.ts` by
...
export type BotTuning = {
   ...
   * (`state.hayBalls`, Boot Hill) must be before the hero sidesteps out of its
...
/** The shape the generated `engine/generated/botTuning.ts` exports: the global
