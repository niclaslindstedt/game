...
// Everything the engine's consumers (engine/index.ts, the sim, the harnesses)
 ...
 * lookup.** Every read under `engine/game/bot/` used to
 ...
 * {@link BUILD_ROTATION} catalog (engine/game/builds.ts), so the autopilot and the
