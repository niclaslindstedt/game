...
// `make levels` compiles into `engine/generated/enemies.ts`; ./index.ts
...
/**
 * The set-piece MECHANICS an elite or boss may carry (see engine/game/mechanics.ts
...
export type EnemyMechanics = {
   ...
   * ability is data plus one module under engine/game/mechanics/, so the next
...
export type EnemyDef = {
   ...
   * is INERT (see engine/game/disposition.ts): blades pass through it, AoE
