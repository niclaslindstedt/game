...
// compiled by scripts/generate-items.mjs into engine/generated/items.ts (see
...
export type WeaponDef = {
   ...
   * (`engine/generated/item-lore.ts`, read by the LIBRARY generator) rather than
 ...
 * REACH-AWARE `WEAPON.meleeAoe` model (`engine/sim/aoe-calibration.ts --reach`).
