...
// `engine/generated/quests.ts` by `scripts/generate-quests.mjs`. Adding an errand
...
export type QuestReward = {
  ...
  cleanSlates?: number;
  /**
   * THE CACHE — this errand hands over the garage chest (engine/game/cache.ts).
   *
...
// tests and mods swap in their own via `registerDefs`). See engine/index.ts.
