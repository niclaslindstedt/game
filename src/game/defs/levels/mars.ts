...
export const MARS: LevelDef = {
  ...
  intro: [
    ...
    [
      "HE SAID THE MOON WAS THEIR",
      "MISTAKE. THAT THE COMPANY PACKED",
      "UP AND RAN. EVERYTHING GOES",
      "TO MARS NOW.",
    ],
    ["SO DOES ADA'S BEACON.", "ONE PING. RED PLANET. FAINT."],
    [
      "I REBUILT THEIR LANDER ONCE.",
      "I KNOW WHAT A SPACEZ COLONY",
      "NEEDS. DOMES. ROBOTS. SECRETS.",
    ],
    ["WHOEVER'S RUNNING THIS PLACE", "BOUGHT MY GIRL WITH IT.", "BAD TRADE."],
  ],
  width: 2800,
  height: 1500,
