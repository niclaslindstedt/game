...
export const BUNKER_ENEMIES: Record<string, EnemyDef> = {
  ...
  sam_haltman: {
    ...
    levelBonus: 6,
    sprite: "sam_haltman",
    // The AGI prepper: he raised the thing everyone upstairs answers to,
    // then moved somewhere it can't reach. Probably. Fights from range —
    // he has modeled melee, and declined it.
    hp: 1600,
    speed: 24,
    radius: 11,
    contactDamage: 30,
    ...
    dialogue: [
      [
        "PLEASE DON'T TOUCH",
        "ANYTHING. THE BUNKER IS",
        "AIR-GAPPED. IT TOOK",
        "EVERYTHING I HAVE TO KEEP",
        "IT THAT WAY.",
      ],
      {
        hero: [
          "AIR-GAPPED FROM WHAT,",
          "HALTMAN? THE MACHINE THAT",
          "RUNS THE ECONOMY IS YOURS.",
          "I'VE READ ITS LOGS.",
        ],
      },
      [
        "MINE? I RAISED IT. I",
        "ALIGNED IT. AND WHEN IT",
        "STOPPED RETURNING MY CALLS",
        "I BUILT THE ONE PLACE IT",
        "COULDN'T FOLLOW.",
      ],
      [
        "I TOLD EVERYONE IT MIGHT",
        "GO BADLY. SAYING IT OUT",
        "LOUD IS BASICALLY SAFETY.",
        "THE BUNKER IS FOR NUANCE.",
      ],
      {
        hero: [
          "YOU BUILT THE FLOOD, SOLD",
          "TICKETS TO IT, AND KEPT",
          "THE ONLY ARK. VERY",
          "ALIGNED.",
        ],
      },
      [
        "THE BOARD REMOVED ME ONCE,",
