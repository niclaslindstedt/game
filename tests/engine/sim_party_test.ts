...
describe("a simulated party", () => {
  it("says nothing about a party when there is not one", () => {
  ...
  it("seats the party it was asked for, each in its own lane", () => {
  ...
  it("takes an authored lane per seat, repeating a short list", () => {
    const report = simulateLevel({
      levelId: "moon",
      difficulty: "medium",
      seed: 7,
  ...
  it("replays identically from the same seed at the same party size", () => {
