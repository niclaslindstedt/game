...
// WHAT THE FIGHT LEFT LYING THERE (pwa/src/game/render/effects.ts
// `restsOnFloor`) — which half of the effect layer an effect belongs to.
//
...
import { restsOnFloor, type Effect } from "../pwa/src/game/render/effects.ts";
