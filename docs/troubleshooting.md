...
| Symptom                                                 | Cause                                                                                                                                                                                                                               |
| ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The mod is not in the MODS screen at all                | Wrong folder — `cli.mjs where` prints both the game reads (`mods/` beside the game, and the data folder). Browser and mobile builds have no mod loader at all, and a non-store desktop download needs `--mods` on its command line. |
