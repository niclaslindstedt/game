...
THE FOUNDER left on Mars), and Eastworld on `rift_exit` (the far door with the
...
- **Level 5 — EASTWORLD** (`levels/eastworld.ts`). The rift's far side: a
  ...
  THE STRONGMAN retreated into to escape the one where he loses. `eastworld` biome
...
GIMMICK weapon, dropped by THE FOUNDER on Mars beside the NOT-A-FLAMETHROWER,
...
RANSOM** (Eastworld). The thin armor slots gain **THE LAST WORD** (GOODCO HQ,
...
corpse. Eastworld's barkeep carries the THE STRONGMAN estate this way (THE STRONGMAN'S
TRACKSUIT, THE KREMLIN USHANKA, HONORARY BLACK BELT), and THE STRONGMAN's own
...
- **Level 5** ships the park's HOSTS — COWBOT (fodder greeters) → SALOON
  ...
  **THE LEAK** (the whistleblower in exile, posted under the water
  ...
  THE FOUNDER finally DIES here** (`the_founder_eastworld`, role boss, no
