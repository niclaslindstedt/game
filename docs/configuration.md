...
| Game speed                   | 1× / 2× / 3× (cycling row)                                   | 1× (real time; fast-forwards the whole run — the hero acts autonomously, so a brisker pace just clears sooner) |
