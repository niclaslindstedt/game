...
| `?botProfile=<build>` | The bot's stat-distribution BUILD — how it spends level-up points (see `src/game/builds.ts`): `melee`, `ranged`, `magic` (focus a weapon lane; each still banks INTELLIGENCE for the reach/AoE-cleave/crit that helps every class), `balanced` (spread reasonably across every stat, no pinned lane), or `auto` (default; the emergent lane from what it has invested in). Through the stat-aware auto-equip the build also decides the weapon and gear. Only meaningful alongside `?bot=`. Unknown names fall back to `auto`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
