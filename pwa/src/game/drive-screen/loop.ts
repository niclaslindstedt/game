...
import type { Effect } from "../render/effects.ts";
import { drawGore } from "../render/gibs.ts";
import { drawStardust } from "../render/stardust.ts";
...
/** One collision flourish, held for as long as its pieces are in the air. */
export type Burst =
  | {
      kind: "gore";
      burst: GoreBurst;
