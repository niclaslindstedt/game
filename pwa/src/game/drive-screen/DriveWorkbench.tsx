 ...
 * them. The opening is a held road as long as the hero's thought takes to read —
 * the wagon sliding in, his line turned a page at a time, then the widening with
 * GET READY over it — which is the right length once a trip and the wrong length
 * forty times an afternoon; this is how a pass about the TOWN skips it without
 * pretending the road is shorter than it is.
 *
