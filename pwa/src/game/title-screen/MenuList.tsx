...
// steering stays there too. The one gesture it owns is a row's secret
// long-press (MenuEntry.hold — the DEVELOPER unlock hides behind the main
// menu's ACHIEVEMENTS row), since the timer belongs with the pointer handlers.
